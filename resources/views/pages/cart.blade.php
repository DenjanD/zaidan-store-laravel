            ...
            <div class="col-12 table-responsive">
              <table class="table table-borderless table-cart">
                ...
                <tbody>
                  ...
                  <tr>
                    <td style="width: 20%">
                      @if($cart->product->photos)
                      <img
                        src="{{ Storage::url($cart->product->photos->first()->name) }}"
                    ...
                    <td style="width: 20%">
                      <form action="{{ route('cart-delete', $cart->cart_id) }}" method="post">
                          @method('delete')
                          @csrf
